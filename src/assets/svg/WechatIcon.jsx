/** WeChat brand mark (from project asset `wechat.svg`). */
export default function WechatIcon({ className }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 1024 1024" fill="none" aria-hidden>
      <path
