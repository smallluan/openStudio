    ...
    try {
      ...
      if (
        ...
        sendJson(req, res, 404, {
          ...
          hint:
            "404 from Open Studio browser-tools bridge (127.0.0.1:19111). Fully quit and restart Open Studio if routes were recently added. GET /health lists supported tools.",
        });
        return;
      }
