...
/**
 * npm project root that owns `node_modules/@tencent-weixin/openclaw-weixin`.
 * @param {string} pluginRoot
 * @returns {string | null}
 */
function findWeixinPluginNpmProjectRoot(pluginRoot) {
  const normalized = path.normalize(String(pluginRoot ?? ""));
